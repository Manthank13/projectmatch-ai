    ...
    <AuthLayout onNavigateHome={() => onNavigate('architect')}>
      <div className="space-y-6 text-center">
        ...
        <div className="relative mx-auto w-20 h-20 rounded-3xl bg-gradient-to-tr from-cyan-500/20 to-violet-500/20 border border-cyan-400/30 flex items-center justify-center shadow-cyan-glow animate-float">
          <div className="w-12 h-12 rounded-2xl bg-space-surface border border-outline-variant/60 flex items-center justify-center">
            <span className="material-symbols-outlined text-3xl text-cyan-400">
              mark_email_read
            </span>
          </div>
          <span className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-mint-accent border-2 border-space-black animate-pulse" />
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs sm:text-sm font-body text-on-surface-variant max-w-sm mx-auto leading-relaxed">
            We've sent a verification link to <strong className="text-cyan-400">{userEmail}</strong>. Please check your inbox and click the link to activate your talent profile.
          </p>
        </div>

        {/* Resend Success Alert */}
        {resendSuccess && (
          <div className="p-3 rounded-2xl bg-mint-accent/15 border border-mint-accent/40 text-mint-accent text-xs font-headline font-bold flex items-center justify-center gap-2 animate-fadeIn">
        ...
        <div className="space-y-3 pt-2">
          <button
            ...
            className="w-full py-3.5 px-6 rounded-2xl bg-gradient-to-r from-cyan-500 to-violet-600 hover:from-cyan-400 hover:to-violet-500 text-space-black font-headline text-xs font-extrabold shadow-cyan-glow hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
          >
          ...
          <a
            ...
            className="w-full py-3 px-6 rounded-2xl glass-input hover:bg-white/[0.08] text-xs font-headline font-bold text-on-surface flex items-center justify-center gap-2 transition-all shadow-sm block"
          >
          ...
          <button
            ...
            className={`w-full py-2.5 px-4 rounded-xl text-xs font-headline font-bold transition-all flex items-center justify-center gap-1.5 ${
              canResend
                ? 'text-cyan-400 hover:text-cyan-300 hover:bg-cyan-500/10 cursor-pointer'
